...
export default function Navbar() {
  return (
    ...
    <>
    <nav className='fixed z-1 top-0 w-full flex items-center justify-between py-5 px-24 border-b border-gray-700 bg-white dark:bg-black text-black dark:text-white transition-all duration-750 ease-out bg-[url(/public/mountains.jpg)]'>
