...
export default function Home() {
  ...
  <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black text-black dark:text-white transition-all duration-300">
    <div className="space-y3 max-w-3xl">
       ...
       <section>
        <h2 className="text-2xl font-semibold text-center">Szukasz profesjonalnej korekty lub składu tekstu? Chcesz, aby tworzone przez Ciebie treści były dopracowane i przyjemne w odbiorze? Jestem tu, aby Ci w tym pomóc!</h2>
